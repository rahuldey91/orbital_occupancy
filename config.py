...
def parse_args():
    ...
    parser.add_argument('--split-test', type=float, default=0.2, help='test split')
    parser.add_argument('--split-train', type=float, default=0.8, help='train split')
    ...
    parser.add_argument('--inc', type=int, default=3, help='input channel dimensions')
    parser.add_argument('--outc', type=int, default=3, help='output channel dimensions')
    parser.add_argument('--D', type=int, default=3, help='depth of the orbit network')
    parser.add_argument('--W', type=int, default=256, help='width of the orbit network')
